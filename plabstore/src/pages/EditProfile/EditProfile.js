                ...
                <GridItem xs={12} sm={4}>
                    <div className="user-tab">
                        ...
                        <div className="d-flex mt-3">
                            <button className="user-tab-btn text-left" onClick={() => setIsEditBio(true)}>Biodata Diri</button>
                        </div>
                        <div className="d-flex mt-3">
                            <button className="user-tab-btn text-left" onClick={() => setIsEditBio(false)}>Daftar Alamat</button>
                        </div>
                    </div>
                </GridItem>
                <GridItem xs={12} sm={8}>
